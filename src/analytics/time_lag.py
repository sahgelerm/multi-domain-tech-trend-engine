...
RAW_PATH = BASE_DIR / "data" / "raw" / "patents.parquet"
OUTPUT_PATH = BASE_DIR / "data" / "time_lag" / "time_lag.csv"
...
def load():
    ...
    df = pd.read_parquet(RAW_PATH, columns=["publication_number", "priority_date"])
    return df
